...
%Processa as distâncias de Jaccard, devolve os items similares e imprime-os.
...
fprintf('Número de pares semelhantes (com distâncias inferiores ao limiar %1.1f): %d\n', threshold, numSimilarPairs) 
fprintf('\nPair 1\tPair 2\tDistancia de Jaccard\n')
